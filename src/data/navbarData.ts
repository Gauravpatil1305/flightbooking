...
export const navbarData: NavbarItem[] = [
    ...
    { name: "Campaign", icon: "material-symbols:campaign-rounded", path: "#"  },
    { name: "Destination", icon: "material-symbols:flight-takeoff-rounded", path: "#"  },
    { name: "Help", icon: "material-symbols:help-outline-rounded", path: "#"  },
    { name: "Contact", icon: "material-symbols:headphones-outline-rounded", path: "#"  },
];